<?php
    ...
    class Estudiante extends Conexion{
        ...
        // metodo con la consulta para crear un nuevo estudiante en la base de datos
        public function crear(){
            ...
            $num = count($resultado);
            // si los datos ya se encuntran en la base de datos se cancela la insercion
            if($num != 0){
                return false;
                ...
                // se almacenan los datos en un array y se coloca su marcador de posicion en la consulta sql
                $params = array(
                ...
                // verificar que los datos se estan enviando
                // $var_dump = var_dump($params);
        ...
        // metodo con la consulta para actualizar
        public function actualizar($Id, $name, $lastName1, $lastName2, $genus, $emailIns, $emailPer, $phoneNumber, $yearsOld, $address) {
            ...
            // se almacenan los datos en un array y se pasan a la consulta con su marcador de posicion
            $params = array(
                ':Id' => $Id,
                ':name' => $name,
                ':lastName1' => $lastName1,
            ...
            // try-catch para capturar el error en caso de que haya uno
            try {   
                $this->con->consultaPreparada($sql, $params);
                return true;
        ...
        // metodo para hacer la consulta por medio de el numero de ficha
